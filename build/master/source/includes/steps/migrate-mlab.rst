...
.. only:: not(html or dirhtml or singlehtml)
   ...
   Step 2: Check your mLab Network Access Mode
   ```````````````````````````````````````````
...
.. only:: not(html or dirhtml or singlehtml)
   ...
   Step 3: Create an oplog user on your admin database
   ```````````````````````````````````````````````````
...
.. only:: not(html or dirhtml or singlehtml)
   ...
   Step 6: Add allowable IP address ranges to your mLab deployment
   ```````````````````````````````````````````````````````````````
...
.. only:: not(html or dirhtml or singlehtml)
   ...
   Step 7: Add the hostname and port of your mLab cluster primary to the Atlas Live Migration dialog
   `````````````````````````````````````````````````````````````````````````````````````````````````
...
.. only:: not(html or dirhtml or singlehtml)
   ...
   Step 9: Specify if Live Migration should use SSL to connect to your mLab cluster
   ````````````````````````````````````````````````````````````````````````````````
